...
signal_filt_path = strcat('./data/filtered_signals/', signal_names(signal_ind), "p", ".mat");
...
s_filt = load(signal_filt_path); disp("ICA + LP / HP / notch filtered signals loaded");
