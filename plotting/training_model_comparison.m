...
if mode == 'Y' || mode == 'y'
    ...
    for i = 1:size(str_vec_model, 2)
        ...
        figure('Position', [404,337.5,597.5,472.5]);
        ...
        title(["Class probability distribution of the", strcat("testing signal epochs: ", prep_labels(1, i))],...
...
elseif mode == 'N' || mode == 'n'
    ...
    figure('Position', [0.13,0.11,0.775,0.815]);
    boxplot([scores_s1; scores_s2; scores_s3; scores_s4; scores_s5; scores_s6],...
            g, 'Notch','on', 'Whisker',1,...
            'Labels',{'W', 'S1', 'S2', 'S3', 'S4', 'R'});
...
prep_labels = ["No Preprocessing", "ICA", "Filtering", "ICA $+$ Filtering", "ICA $+$ Filtering$^{*}$"];
...
if mode == 'Y' || mode == 'y'
    ...
    figure('Position', [212.5,217,691,535]);
    for i = 1:size(str_vec_model, 2)
        ...
        legend([ax(:)], prep_labels,...
               ...
               'Position',[0.182585624698504,0.727414330218068,0.220185690904823,0.129906538490937]);
